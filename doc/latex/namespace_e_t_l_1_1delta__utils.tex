...
\item 
def \mbox{\hyperlink{namespace_e_t_l_1_1delta__utils_a6b62f88410500ab26e74a36480f25ca7}{get\+\_\+inserts\+\_\+updates\+\_\+deletes}} (config, zone, table, path, unique\+\_\+key, database\+\_\+name=\textquotesingle{}default\textquotesingle{}, old\+\_\+version=None)
...
drop: bool, optional
  Drop table
\end{DoxyVerb}
 \mbox{\Hypertarget{namespace_e_t_l_1_1delta__utils_a6b62f88410500ab26e74a36480f25ca7}\label{namespace_e_t_l_1_1delta__utils_a6b62f88410500ab26e74a36480f25ca7}} 
\index{ETL.delta\_utils@{ETL.delta\_utils}!get\_inserts\_updates\_deletes@{get\_inserts\_updates\_deletes}}
\index{get\_inserts\_updates\_deletes@{get\_inserts\_updates\_deletes}!ETL.delta\_utils@{ETL.delta\_utils}}
\doxysubsubsection{\texorpdfstring{get\_inserts\_updates\_deletes()}{get\_inserts\_updates\_deletes()}}
{\footnotesize\ttfamily def E\+T\+L.\+delta\+\_\+utils.\+get\+\_\+inserts\+\_\+updates\+\_\+deletes (\begin{DoxyParamCaption}\item[{}]{config,  }\item[{}]{zone,  }\item[{}]{table,  }\item[{}]{path,  }\item[{}]{unique\+\_\+key,  }\item[{}]{database\+\_\+name = {\ttfamily \textquotesingle{}default\textquotesingle{}},  }\item[{}]{old\+\_\+version = {\ttfamily None} }\end{DoxyParamCaption})}

\begin{DoxyVerb}Returns data that was inserted, updated and deleted in the last delta table write operation.
